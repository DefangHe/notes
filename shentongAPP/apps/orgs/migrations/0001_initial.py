# Generated by Django 2.2.1 on 2019-07-21 11:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=200, upload_to='orgs/', verbose_name='机构封面')),
                ...
                ('category', models.CharField(choices=[('pxgj', '培训机构'), ('gx', '高校'), ('gr', '个人')], max_length=10, verbose_name='机构类别')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
